 ...
 */
class Categoria extends \Cookbook\Entity\Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cookbook\\Entity\\Categoria' . "\0" . 'id', '' . "\0" . 'Cookbook\\Entity\\Categoria' . "\0" . 'descricao', '' . "\0" . 'Cookbook\\Entity\\Categoria' . "\0" . 'dataCriacao', '' . "\0" . 'Cookbook\\Entity\\Categoria' . "\0" . 'tipo');
        }
