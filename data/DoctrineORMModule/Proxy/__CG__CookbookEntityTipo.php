 ...
 */
class Tipo extends \Cookbook\Entity\Tipo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cookbook\\Entity\\Tipo' . "\0" . 'id', '' . "\0" . 'Cookbook\\Entity\\Tipo' . "\0" . 'descricao', '' . "\0" . 'Cookbook\\Entity\\Tipo' . "\0" . 'dataCriacao');
        }
